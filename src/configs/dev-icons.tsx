export const devIcons = [
    ...
    { iconName: 'devicon-symfony-plain', name: 'Symfony' },
    ...
    { iconName: 'devicon-astro-plain', name: 'Astro' },
    ...
    { iconName: 'devicon-googlecloud-plain', name: 'Google Cloud' },

    
    { iconName: 'devicon-coffeescript-plain', name: 'Café' },
