...
metadata:
  excerpt: 'Ecole : école informatique, développement web Full Stack, cybersécurité, alternance.'
started_at: 2014-02
ended_at: 2018-01
technology:
  - Symfony
  ...
  - Zend
  - Laravel
linkedin_url: 'https://www.linkedin.com/school/it-akademy'
---
...
3. **Intégrer des technologies modernes** : S’assurer que les programmes de formation restent à jour avec les dernières technologies et méthodologies pédagogiques.
...
5. **Encourager l’autonomie des étudiants** : Aider les étudiants à devenir autonomes dans leur apprentissage et leur utilisation des outils et technologies enseignés.

## Principaux points à retenir

J’ai développé des compétences solides en pédagogie, en adaptant mes cours à différents niveaux de compétence et en utilisant des différences méthodologies.

J’ai appris à encourager l’autonomie des étudiants, les aidant à devenir indépendants dans leur apprentissage et leur utilisation des technologies.
